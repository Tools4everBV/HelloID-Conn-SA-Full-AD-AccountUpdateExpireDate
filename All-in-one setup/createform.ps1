...
AD Account - Update account expires
'@
Invoke-HelloIDDelegatedForm -DelegatedFormName $delegatedFormName -DynamicFormGuid $dynamicFormGuid -AccessGroups $delegatedFormAccessGroupGuids -Categories $delegatedFormCategoryGuids -UseFaIcon "True" -FaIcon "fa fa-calendar" -returnObject ([Ref]$delegatedFormRef) 
<# End: Delegated Form #>
